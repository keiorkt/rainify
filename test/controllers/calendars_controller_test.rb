...
class CalendarsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create calendar" do
    assert_difference('Calendar.count') do
      post calendars_url, params: { calendar: { owner_identifier: @calendar.owner_identifier, summary: @calendar.summary } }
    end
  ...
  test "should update calendar" do
    patch calendar_url(@calendar), params: { calendar: { owner_identifier: @calendar.owner_identifier, summary: @calendar.summary } }
